...
import { CropBanner, CroppedArea } from "./cropBanner.js";
...
export const ProfileStep3 = ({ setStep, selectedFile, onConfirm }: Props) => {
  ...
  useEffect(() => {
    normalizeImage(selectedFile, 1440).then((result) => {

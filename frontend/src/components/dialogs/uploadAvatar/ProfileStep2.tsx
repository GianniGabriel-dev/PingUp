    ...
    <>
        ...
        <footer className="p-2.5 flex max-sm:flex-col max-sm:h-2/12 justify-center  items-center gap-7 w-full  text-center bg-zinc-950 text-white rounded-b-2xl">
            <Slider
                ...
                max={3}
            />
            <button onClick={handleConfirm} className="text-zinc-950 bg-white hover:bg-white/55 cursor-pointer  h-10 w-5/12 max-sm:w-full text-xl   transition-all duration-300  font-bold rounded-3xl shadow">
                Confirmar
            </button>
        </footer>
    </>
